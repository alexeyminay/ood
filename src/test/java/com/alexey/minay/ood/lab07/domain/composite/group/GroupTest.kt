...
//        group.fillStyle = IFillStyle(true, commonColor)
...
//        val group = createGroup(firstColor, secondColor)
//        val commonColor = RGBAColor.BLUE
//        group.style.lineStyle = ILineStyle(true, commonColor)
...
//            style = SimpleStyle(
//                fillStyle = IFillStyle(true, RGBAColor.YELLOW),
//                lineStyle = ILineStyle(true, RGBAColor.YELLOW)
//            ),
...
//        firstShape.style.fillStyle = IFillStyle(true, newFirstShapeFillColor)
//
...
//            val firstShape = Triangle(
//                style = SimpleStyle(
//                    fillStyle = IFillStyle(true, firstShapeColor),
//                    lineStyle = ILineStyle(true, firstShapeColor)
//                ),
//                shapeFrame = Frame(20.0, 260.0, 150.0, 250.0)
//            )
//            val secondShape = Ellipse(
//                style = SimpleStyle(
//                    fillStyle = IFillStyle(true, secondShapeColor),
//                    lineStyle = ILineStyle(true, secondShapeColor)
//                ),
//                shapeFrame = Frame(700.0, 800.0, 30.0, 130.0)
//            )
//            insertShape(firstShape, 0)
