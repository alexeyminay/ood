...
//        val lineStyle = SimpleLineStyle(true, color)
//        Mockito.`when`(mLineStyle.color).thenReturn(color)
//        Mockito.`when`(mEllipse.fillStyle).thenReturn(SimpleFillStyle(true, color))
...
//        val color = RGBAColor.BLUE
//        val lineStyle = SimpleLineStyle(false, color)
//        Mockito.`when`(mEllipse.lineStyle).thenReturn(lineStyle)
//        Mockito.`when`(mEllipse.fillStyle).thenReturn(SimpleFillStyle(true, color))
//        mEllipse.draw(mCanvas)
...
//        val color = RGBAColor.BLUE
//        val lineStyle = SimpleLineStyle(false, color)
//        Mockito.`when`(mLineStyle).thenReturn(lineStyle)
//        Mockito.`when`(mFillStyle).thenReturn(SimpleFillStyle(true, color))
//
//        mEllipse.draw(mCanvas)
//
